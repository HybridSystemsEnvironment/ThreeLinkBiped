...
public class ParameterEvaluator {
	...
	public static boolean validEquilibSolution(BipedParameters params) {
		...
		EquilibriumComputer computer = new EquilibriumComputer(new BipedState(), params);

		Double[] valuesToCheck = new Double[] { computer.computeInitialPlantedLegVelocity(),
				computer.computeInitialPlantedLegVelocity(), computer.computeInitialTorsoVelocity(),
				computer.computeFinalPlantedLegVelocity(), computer.computeFinalSwingLegVelocity(),
				computer.computeFinalTorsoVelocity() };
	...
	public static boolean paramsInParamSpace(BipedParameters params) {
		...
		Double[] positiveVals = new Double[] { params.gravity, params.hipMass, params.legLength, params.legMass,
				params.torsoLength, params.torsoMass, params.walkSpeed, };
