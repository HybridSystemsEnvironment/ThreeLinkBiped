...
public class BipedModelFactory {
	...
	public static VirtualBipedState getRandomVirtualBipedState(Double planted_angle_min, Double planted_angle_max,
			...
			Double planted_velocity_min, Double planted_velocity_max, Double swing_velocity_min,
			Double swing_velocity_max, Double torso_velocity_min, Double torso_velocity_max) {
