...
public class ParameterEvaluator
{
	...
	public static boolean validEquilibSolution(BipedParameters params)
	{
		...
		//		boolean initialVelValidNums = (!initPlantedVel.isNaN()) && (!initSwingVel.isNaN()) && (!initTorsoVel.isNaN());
		//		boolean initialVelNonInfinite = (!initPlantedVel.isInfinite()) && (!initSwingVel.isInfinite())
		...
		//		boolean FinalVelValidNums = (!finalPlantedVel.isNaN()) && (!finalSwingVel.isNaN()) && (!finalTorsoVel.isNaN());
		//		boolean FinalVelNonInffinale = (!finalPlantedVel.isInfinite()) && (!finalSwingVel.isInfinite())
